...
const { FiPlus, FiEdit, FiTrash2, FiAward, FiEye, FiDownload, FiCheck, FiX } = FiIcons;
...
const Certificates = () => {
  const [certificates, setCertificates] = useState([
    ...
    },
    {
      ...
      certificateId: 'CERT-AJS-2024-002',
      grade: 'B+',
      score: 87,
      status: 'issued',
      isVerified: true
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">ID: {certificate.certificateId}</p>
                  </div>
                </div>
